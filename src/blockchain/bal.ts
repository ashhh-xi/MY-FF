...
import { walletAddressState } from "@/recoil/atoms/userAtoms"; // Import walletAddressState

// Simplified ABI of your smart contract
const simplifiedABI = [
  {
    inputs: [
      {
  ...
  get: async ({ get }) => {
    ...
    try {
      ...
      if (network.chainId !== expectedChainId) {
        throw new Error(
          `Connected to the wrong network: ${network.name}. Please switch to Sepolia.`
        );
      }
